...
{
  public: 
  MPU9250K(uint8_t intPin);
  uint8_t getMPU9250ID(uint8_t MPUnum);
  uint8_t getAK8963CID(uint8_t MPUnum);
  void resetMPU9250(uint8_t MPUnum);
  void initMPU9250(uint8_t MPUnum, uint8_t Ascale, uint8_t Gscale, uint8_t sampleRate);
  void initAK8963Slave(uint8_t MPUnum, uint8_t Mscale, uint8_t Mmode, float * destination);
